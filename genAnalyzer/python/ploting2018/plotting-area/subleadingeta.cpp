...
TH1F *j1 = new TH1F("j1","subleading lepton eta",15,-3.,3.);
T1->Draw("subleading_eta>>j1","totalweight*1");  
  j1->SetLineColor(kBlack);
  j1->SetLineWidth(2);
  j1->SetStats(0);

TH1F *j2 = new TH1F("j2","subleading lepton eta",15,-3.,3.);
T2->Draw("subleading_eta>>j2","startweight");                                                                                                
  j2->SetLineColor(kBlue);
  j2->SetLineWidth(2);
  j2->SetStats(0); 
  j2->GetYaxis()->SetLabelSize(0.020);
TH1F *j3 = new TH1F("j3","subleading lepton eta",15,-3.,3.);
T3->Draw("subleading_eta>>j3","totalweight*1");
  j3->SetLineColor(kGreen);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","subleading lepton eta",15,-3.,3.);
T4->Draw("subleading_eta>>j4","startweight");
...
TPad *pad2 = new TPad("pad2","pad2",0,0,1,0.2);
  ...
  h1->SetMaximum(2.0);
  h1->SetTitle("");
  h1->GetXaxis()->SetTitle("Sub leading Lepton eta ");
 ...
 h3->Divide(h4);
  ...
  h3->SetMaximum(1.8);
  h3->SetTitle("");
  h3->GetXaxis()->SetTitle("Sub eading Lepton eta ");
...
c1->SaveAs("Lepton_subleading_eta.png");
c1->Write();
