...
TH1F *j1 = new TH1F("j1","Subleading Jet eta",20,-5.,5.);
T1->Draw("subleadingjet_eta>>j1","totalweight");  
  j1->SetLineColor(kBlack);
  j1->SetLineWidth(2);
  j1->SetStats(0);

TH1F *j2 = new TH1F("j2","Subleading Jet eta",20,-5.,5.);
T2->Draw("subleadingjet_eta>>j2","startweight");                                                                                                
  j2->SetLineColor(kBlue);
  j2->SetLineWidth(2);
  j2->SetStats(0); 
  j2->GetYaxis()->SetLabelSize(0.020);
TH1F *j3 = new TH1F("j3","Subleading Jet eta",20,-5.,5.);
T3->Draw("subleadingjet_eta>>j3","totalweight");
  j3->SetLineColor(kGreen);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","Subleading Jet eta",20,-5.,5.);
T4->Draw("subleadingjet_eta>>j4","startweight");
...
TPad *pad2 = new TPad("pad2","pad2",0,0,1,0.2);
  ...
  h1->SetMaximum(1.8);
  h1->SetTitle("");
  h1->GetXaxis()->SetTitle("Subleading Jet eta ");
  ...
  h3->SetMaximum(1.8);
  h3->SetTitle("");
  h3->GetXaxis()->SetTitle("Subleading Jet eta ");
...
c1->SaveAs("Jet_Subleading_eta.png");
c1->Write();
