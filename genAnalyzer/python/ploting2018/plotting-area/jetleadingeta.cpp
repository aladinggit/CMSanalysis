...
TH1F *j3 = new TH1F("j3","Leading Jet eta",20,-5.,5.);
T3->Draw("leadingjet_eta>>j3","totalweight");
  j3->SetLineColor(kGreen);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","Leading Jet eta",20,-5.,5.);
T4->Draw("leadingjet_eta>>j4","startweight");
