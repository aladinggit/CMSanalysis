...
TH1F *j3 = new TH1F("j3","Leading Jet phi",22,-3.3,3.3);
T3->Draw("leadingjet_phi>>j3","totalweight*1");
  j3->SetLineColor(kGreen);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","Leading Jet phi",22,-3.3,3.3);
T4->Draw("leadingjet_phi>>j4","startweight");
