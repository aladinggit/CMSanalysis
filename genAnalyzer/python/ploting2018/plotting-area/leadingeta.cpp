...
TH1F *j3 = new TH1F("j3","Leading lepton eta",15,-3.,3.);
T3->Draw("leading_eta>>j3","totalweight*1");
 j3->GetYaxis()->SetRangeUser(0, 600);
  j3->SetLineColor(kGreen);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","Leading Jet eta",15,-3.,3.);
T4->Draw("leading_eta>>j4","startweight");
 j2->GetYaxis()->SetRangeUser(0, 600);
...
TPad *pad2 = new TPad("pad2","pad2",0,0,1,0.2);
  ...
  h3->SetMaximum(1.8);
  h3->SetTitle("");
  h3->GetXaxis()->SetTitle("Leading Lepton eta ");
