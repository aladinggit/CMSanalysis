...
TH1F *j1 = new TH1F("j1","PTll",50,-25.,300.);
T1->Draw("ptll>>j1","totalweight*1");  
  j1->SetLineColor(kBlack);
  j1->SetLineWidth(2);
  j1->SetStats(0);

TH1F *j2 = new TH1F("j2","PTll",50,-25.,300.);
T2->Draw("ptll>>j2","startweight");                                                                                                
  j2->SetLineColor(kBlue);
  j2->SetLineWidth(2);
  j2->SetStats(0); 
  j2->GetYaxis()->SetLabelSize(0.020);

TH1F *j3 = new TH1F("j3","PTll",50,-25.,300.);
T3->Draw("ptll>>j3","totalweight*1");
  j3->SetLineColor(kGreen);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","PTll",50,-25.,300.);
T4->Draw("ptll>>j4","startweight");
