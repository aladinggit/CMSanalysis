...
TH1F *j1 = new TH1F("j1","wwm",50,-25.,600.);
T1->Draw("wwm>>j1","totalweight*1");  
  j1->SetLineColor(kBlack);
  j1->SetLineWidth(2);
  j1->SetStats(0);

TH1F *j2 = new TH1F("j2","wwm",50,-25.,600.);
T2->Draw("wwm>>j2","startweight");                                                                                                
  j2->SetLineColor(kBlue);
  j2->SetLineWidth(2);
  j2->SetStats(0); 
  j2->GetYaxis()->SetLabelSize(0.020);
TH1F *j3 = new TH1F("j3","wwm",50,-25.,600.);
T3->Draw("wwm>>j3","totalweight*1");
  j3->SetLineColor(kGreen);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","wwm",50,-25.,600.);
T4->Draw("wwm>>j4","startweight");
...
TPad *pad2 = new TPad("pad2","pad2",0,0,1,0.2);
  ...
  h1->SetMaximum(1.6);
  h1->SetTitle("");
  h1->GetXaxis()->SetTitle("Invariant Mass of the WW (GeV)");
