...
TH1F *j3 = new TH1F("j3","wwpt",50,-25.,300.);
T1->Draw("wwpt>>j3","totalweight1005");
  j3->SetLineColor(kRed);
  j3->SetLineWidth(2);
  j3->SetStats(0);

TH1F *j4 = new TH1F("j4","wwpt",50,-25.,300.);
T1->Draw("wwpt>>j4","totalweight1009");
...
for(int i=0;i< h1->GetNbinsX(); i++ ){
    ...
    std::cout << "watch out" << h3->GetBinContent(i) << h4->GetBinContent(i) << std::endl;
    h1 ->SetBinError(i, a);
    h4 ->SetBinError(i, 0);
    h3 ->SetBinError(i, 0);
}
